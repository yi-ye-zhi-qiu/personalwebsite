...
/**
"Pixie dust" effect made by Rik Schennik, all credit goes to them.
https://codepen.io/rikschennink/full/VaqNgx
https://codepen.io/rikschennink
**/
console.clear();
...
simulate(
		'2d', {
				...
				paint: function(particle) {
					...
					this.paint.circle(p.x, p.y, s, 'rgba(242,169,169,' + o +')');
					...
					this.context.fillStyle = 'rgba(242,169,169,' + (o * .025) + ')';
					this.context.fill();
