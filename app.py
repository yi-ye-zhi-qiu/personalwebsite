...
def showMango():
    ...
    mojo = pd.read_csv('static/data/mojo_revised.csv')
    imdb = pd.read_csv('static/data/imdb.csv')
    metacritic = pd.read_csv('static/data/metacritic.csv')
    tomato = pd.read_csv('static/data/rotten_tomatoes.csv')
    heirloom = pd.read_csv('static/data/heirloom.csv')
