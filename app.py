...
def showMango():
    ...
    # cor = df.corr()
    # fig, ax = plt.subplots()
    # sns.heatmap(cor, annot=True, cmap="YlGnBu", cbar_kws={"orientation": "horizontal"})
    # fig.savefig('static/images/heatmap_1', dpi=500)
    # sns.displot(df, x="imdbscore")
    ...
    html_data = df_final
    return render_template('mangodb.html', html_data = html_data, liams_favorite = liams_favorite)
